...
export default class Profile extends Component{
      ...
      appTitle: { flex: 0.07, flexDirection: "row" },
       iconImage: { width: "100%", height: "100%", resizeMode: "contain" },
        appTitleTextContainer: { flex: 0.7, justifyContent: "center" },
         ...
         profileImageContainer: { flex: 0.5, justifyContent: "center", alignItems: "center" }, 
  ...
  themeTextLight: { color: "black", fontSize: RFValue(30), fontFamily: "Bubblegum-Sans", marginRight: RFValue(15) },
   });
